...
class ContactPageState extends State<ContactPage> {
  ...
  Widget _buildContactRow(ContactResponse contact) {
  ...
  void _navigateToEditContactPage(BuildContext context, ContactResponse contact) async {
    //todo uncomment:
  ...
  Widget contactAvatar(ContactResponse contact) {
    return new Hero(
      tag: contact.id,
      child: new Avatar(
  ...
  Widget contactDetails(ContactResponse contact) {
    return new Flexible(
        child: new Container(
      child: new Column(
  ...
  void _heroAnimation(ContactResponse contact) {
  ...
  void deleteContact(ContactResponse contact) async {
     //todo: uncomment
