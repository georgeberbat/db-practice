...
const String GOOGLE_PLACE_API_KEY = "AIzaSyBd6gUvk9JrIaZts-esMw7k3EE0M4Y9RJA";

class APIConstants {
  static const String _CONTACT_API_BASE_URL = "http://localhost:5000";
  
  static const String GROUP_GET = 
  _CONTACT_API_BASE_URL + "/Group/Get";

  static const String CATEGORIES_GET = 
  _CONTACT_API_BASE_URL + "/PhoneCategory/Get";

  static const String READ_CONTACTS =
      _CONTACT_API_BASE_URL + "/User/GetUsers";

  static const String SEARCH_CONTACT =
      _CONTACT_API_BASE_URL + "/User/GetUsers";

  static const String CREATE_CONTACT =
      _CONTACT_API_BASE_URL + "/User/Save";

  static const String DELETE_CONTACT =
      _CONTACT_API_BASE_URL + "/User/Delete";

  static const String UPDATE_CONTACT =
      _CONTACT_API_BASE_URL + "/User/Save";

  static const String READ_DELETED_CONTACTS =
      _CONTACT_API_BASE_URL + "";

  static const String OCTET_STREAM_ENCODING = "application/octet-stream";

  static const String JSON_ENCODING = "application/json";
}

class APIResponseCode {
  static const int SC_OK = 200;
  static const int SC_CREATED = 200;
...
class ContactTable {
  ...
  static String PHONE = "phoneNumbers";
  static String EMAIL = "email";
  static String ADDRESS = "address";
  static String LATITUDE = "latitude";
  static String LONGITUDE = "longitude";
  static String CONTACT_IMAGE = "contact_image";
  static String GROUP_IDS = "group_ids";
}
